Name:          openstack-savanna-virtualenv-python-pbr
Version:       0.5.21
Release:       1%{?dist}
Summary:       python-pbr installed into virtual env for openstack-savanna
License:       ASL 2.0
...
- python-pbr for Savanna into virtualenv. Initial spec created.
