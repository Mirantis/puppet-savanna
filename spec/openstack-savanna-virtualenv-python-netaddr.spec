Name:          openstack-savanna-virtualenv-python-netaddr
Version:       0.7.10
Release:       1%{?dist}
Summary:       python-netaddr installed into virtual env for openstack-savanna
License:       ASL 2.0
...
- python-netaddr for Savanna into virtualenv. Initial spec created.
