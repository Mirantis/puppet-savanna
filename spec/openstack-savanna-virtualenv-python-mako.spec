Name:          openstack-savanna-virtualenv-python-mako
Version:       0.8.1
Release:       1%{?dist}
Summary:       python-mako installed into virtual env for openstack-savanna
License:       ASL 2.0
...
- python-mako for Savanna into virtualenv. Initial spec created.
