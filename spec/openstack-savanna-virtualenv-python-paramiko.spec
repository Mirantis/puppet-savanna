Name:          openstack-savanna-virtualenv-python-paramiko
Version:       1.11.0
Release:       1%{?dist}
Summary:       python-paramiko installed into virtual env for openstack-savanna
License:       ASL 2.0
URL:           https://launchpad.net/savanna
Source0:       paramiko-%{version}.tar.gz
Source1:       openstack-savanna-virtualenv-0.1-1.el6.x86_64.rpm
Source2:       openstack-savanna-virtualenv-python-pycrypto-2.6-1.el6.noarch.rpm
BuildArch:     noarch
...
- python-paramiko for Savanna into virtualenv. Initial spec created.
