Name:          openstack-savanna-virtualenv-python-sqlalchemy
Version:       0.7.10
Release:       1%{?dist}
Summary:       python-sqlalchemy installed into virtual env for openstack-savanna
License:       ASL 2.0
...
- python-sqlalchemy for Savanna into virtualenv. Initial spec created.
