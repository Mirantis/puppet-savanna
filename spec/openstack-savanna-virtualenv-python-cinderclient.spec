Name:          openstack-savanna-virtualenv-python-cinderclient
Version:       1.0.5
Release:       1%{?dist}
Summary:       python-cinderclient ionstalled into virtual env for openstack-savanna
License:       ASL 2.0
...
- python-cinderclient for Savanna into virtualenv. Initial spec created.
