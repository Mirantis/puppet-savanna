Name:          openstack-savanna-virtualenv-python-pycrypto
Version:       2.6
Release:       1%{?dist}
Summary:       python-pycrypto installed into virtual env for openstack-savanna
License:       ASL 2.0
...
- python-pycrypto for Savanna into virtualenv. Initial spec created.
