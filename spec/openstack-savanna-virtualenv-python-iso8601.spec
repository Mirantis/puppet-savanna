Name:          openstack-savanna-virtualenv-python-iso8601
Version:       0.1.4
Release:       1%{?dist}
Summary:       python-iso8601 installed into virtual env for openstack-savanna
License:       ASL 2.0
...
- python-iso8601 for Savanna into virtualenv. Initial spec created.
