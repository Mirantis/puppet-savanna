Name:          openstack-savanna-virtualenv-python-werkzeug
Version:       0.9.3
Release:       1%{?dist}
Summary:       python-werkzeug ionstalled into virtual env for openstack-savanna
License:       ASL 2.0
...
%description
werkzeug in virtual environment for openstack-savanna
...
- python-werkzeug for Savanna into virtualenv. Initial spec created.
