Name:          openstack-savanna-virtualenv-python-oslo-config
Version:       1.1.1
Release:       1%{?dist}
Summary:       python-oslo-config installed into virtual env for openstack-savanna
License:       ASL 2.0
...
- python-oslo-config for Savanna into virtualenv. Initial spec created.
