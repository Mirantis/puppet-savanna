Name:          openstack-savanna-virtualenv-python-jinja2
Version:       2.7.1
Release:       1%{?dist}
Summary:       python-jinja2 ionstalled into virtual env for openstack-savanna
License:       ASL 2.0
...
%description
jinja2 in virtual environment for openstack-savanna
...
- python-jinja2 for Savanna into virtualenv. Initial spec created.
