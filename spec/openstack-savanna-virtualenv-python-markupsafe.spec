Name:          openstack-savanna-virtualenv-python-markupsafe
Version:       0.18
Release:       1%{?dist}
Summary:       python-markupsafe installed into virtual env for openstack-savanna
License:       ASL 2.0
...
- python-markupsafe for Savanna into virtualenv. Initial spec created.
